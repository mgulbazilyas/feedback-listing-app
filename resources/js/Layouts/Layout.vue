      ...
      <nav class="bg-white border-b border-gray-100">
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <NavLink :href="route('homepage')" :active="route().current('homepage')"> Home </NavLink>
                <NavLink v-if="$page.props.auth.user && $page.props.auth.user.role=='admin'" :href="route('users')" :active="route().current('users')"> Users </NavLink>
        ...
        <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
          <div class="pt-2 pb-3 space-y-1">
            <ResponsiveNavLink :href="route('users')" :active="route().current('users')"> Users </ResponsiveNavLink>
          </div>
